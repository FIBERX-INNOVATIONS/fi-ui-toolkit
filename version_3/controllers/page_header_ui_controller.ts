...
> {
    ...
    protected getUIComputedData(): ComputedDefinitionType<PageHeaderUIComputedDataInterface> {
        return {
            has_actions: () => {
                return Array.isArray(this.props.action_buttons) && this.props.action_buttons.length > 0;
            },
            ...
            display_action_buttons: () => {
                return Array.isArray(this.props.action_buttons) ? this.props.action_buttons : [];
            }
        };
    }
}
