...
import { APIRequestConfig, APIResponseInterface } from "../types/api_util_type";

import APIClient from "../api_utils/api_client_util";

class BaseAPIService {
    protected static async queryAPI<T>(config: APIRequestConfig): Promise<APIResponseInterface<T>> {
        try {
            ...
            const msg = error?.response?.data?.msg || error?.msg || "invalid_request";
