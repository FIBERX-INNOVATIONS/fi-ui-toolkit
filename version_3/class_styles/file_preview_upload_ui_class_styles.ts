...
const FilePreviewUploadUIClassStyles: FilePreviewUploadUIClassStylesInterface = {
    ...
    preview_container_class_style: "flex-1 max-h-[500px] overflow-y-auto overflow-x-hidden flex flex-col gap-3",

    file_item_wrapper_class_style: "relative border rounded-lg p-2 flex items-center justify-center",
    ...
    bottom_action_wrapper_class_style:
        "sticky bottom-0 bg-white pt-3 border-dashed border-2 p-4 text-center cursor-pointer",
