...
export interface OverlayUIActionPropsInterface {
    on_open?: (config?: { props: OverlayUIPropsInterface }) => Promise<OverlayUIActionReturnInterface | void>;

    on_close?: (config?: { props: OverlayUIPropsInterface }) => Promise<OverlayUIActionReturnInterface | void>;
