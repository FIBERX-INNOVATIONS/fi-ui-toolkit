...
class PageHeaderUIPropsBuilder {
    ...
    public static configure(class_styles?: PageHeaderUIClassStylesInterface): void {
        PageHeaderUIPropsBuilder.class_styles = class_styles || PageHeaderUIClassStyles;
    }
    ...
    private static buildPropsObject(
        ...
        return {
            ...
            class_styles: overrides.class_styles ?? PageHeaderUIPropsBuilder.class_styles ?? PageHeaderUIClassStyles
        };
    }
    ...
    public static getReactivePropsObject(
        ...
        const props = PageHeaderUIPropsBuilder.buildPropsObject(
            header_props,
            action_buttons,
            description_text,
            overrides
