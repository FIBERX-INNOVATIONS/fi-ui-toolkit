...
class InputGroupUIPropsBuilder extends BasePropSchema<InputGroupUIPropsInterface> {
    ...
    private static getContentProps(content_key?: string) {
        ...
        return InputGroupUIPropsBuilder.content_manager?.get<InputUIContentPayloadInterface>(content_key) ?? {};
    }
    ...
    private static buildPropsObject(
        ...
        const content_data = InputGroupUIPropsBuilder.getContentProps(content_key);
