...
import { BreadcrumbUIPropsInterface, BreadcrumbUIClassStylesInterface } from "../ui_types/breadcrumb_ui_type";
...
class BreadcrumbUIPropsBuilder {
    ...
    public static configure(class_styles?: BreadcrumbUIClassStylesInterface): void {
        BreadcrumbUIPropsBuilder.class_styles = class_styles || BreadcrumbUIClassStyles;
    }
    ...
    private static buildPropsObject(
        ...
        return {
            ...
            class_styles: overrides.class_styles ?? BreadcrumbUIPropsBuilder.class_styles ?? BreadcrumbUIClassStyles
        };
    }
    ...
    public static getReactivePropsObject(
        ...
        const props = BreadcrumbUIPropsBuilder.buildPropsObject(id, breadcrumb_items, overrides);
    ...
    public static getReactivePropsObjectFromContent(
        ...
        return BreadcrumbUIPropsBuilder.getReactivePropsObject(id, nav_links, {
            class_styles,
            separator
        });
    }
