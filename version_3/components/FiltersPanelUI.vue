<template>
    <div :class="class_styles.wrapper_class_style">
        ...
        <!-- Panel -->
        <div v-show="state_refs.is_open.value" :class="class_styles.panel_wrapper_class_style">
            <!-- Filters Grid -->
            ...
            <div :class="class_styles.actions_wrapper_class_style">
                <ButtonUI v-if="clear_button" v-bind="clear_button" @click="action_handler?.clearFilters?.()" />

                <ButtonUI v-if="apply_button" v-bind="apply_button" @click="action_handler?.applyFilters?.()" />
            </div>
        </div>
    </div>
</template>
...
const { toggle_btn_content, filter_fields, apply_button, clear_button, class_styles } = props;

const { state_refs, action_handler, components } = controller;
