<template>
    <div :class="class_styles.wrapper_class_style">
        ...
        <div :class="class_styles.actions_wrapper_class_style">
            <ButtonUI v-bind="cancel_button_props" />

            <ButtonUI v-bind="confirm_button_props" />
        </div>
    </div>
</template>
...
const { content_props, confirm_button_props, cancel_button_props, class_styles } = props;

const { components, action_handler: _action_handler } = controller;
