...
class ImageRenderUIPropsBuilder extends BasePropSchema<ImageRenderUIPropsInterface> {
    ...
    public static configure(
        ...
        ImageRenderUIPropsBuilder.class_styles = class_styles || ImageRenderUIClassStyles;

        ImageRenderUIPropsBuilder.default_boolean_props = boolean_props || {};

        ImageRenderUIPropsBuilder.default_action_props = action_props || {};
    }
    ...
    private static buildPropsObject(
        ...
        return {
            ...
            class_styles: overrides.class_styles ?? ImageRenderUIPropsBuilder.class_styles ?? ImageRenderUIClassStyles
        };
    }
    ...
    public static getReactivePropsObjectFromContent(
        ...
        const props = ImageRenderUIPropsBuilder.buildPropsObject(id, img_link, {
            ...overrides,
