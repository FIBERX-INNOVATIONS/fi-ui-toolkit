import { RefreshTokenHandlerType, RefreshCSRFHandlerType } from "../types/api_util_type";
...
class RetryManagerUtil {
    ...
    public static registerRefreshTokenHandler(handler: RefreshTokenHandlerType) {
        this.refresh_token_handler = handler;
    }

    public static registerCSRFHandler(handler: RefreshCSRFHandlerType) {
