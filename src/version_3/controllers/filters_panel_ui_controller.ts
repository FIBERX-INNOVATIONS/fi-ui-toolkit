...
class FiltersPanelUIController extends BaseController<
    ...
    FiltersPanelUIComponentsInterface
> {
    public action_handler: FiltersPanelUIActionHandler = new FiltersPanelUIActionHandler(this);
    ...
    protected getUIComputedData(): ComputedDefinitionType<FiltersPanelUIComputedDataInterface> {
        return {
            has_filters: () => {
                return Array.isArray(this.props.filter_fields) && this.props.filter_fields.length > 0;
            }
        };
    }
