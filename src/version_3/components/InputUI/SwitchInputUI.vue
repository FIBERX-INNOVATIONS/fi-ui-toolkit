<template>
    <div :class="class_styles.wrapper_class_style">
        ...
        <button
            ...
            type="button"
            :class="[
                class_styles.switch_btn_class_style,
                InputTransformerUtil.resolveTypedValue(input_value)
                    ? class_styles.active_class_style
                    : class_styles.inactive_class_style
            ]"
        ...
        >
            ...
            <span
                :class="[
                    class_styles.knob_class_style,
                    InputTransformerUtil.resolveTypedValue(input_value) ? 'translate-x-6' : 'translate-x-1'
                ]"
            ></span>
            <span
                v-if="helper_text"
                :class="class_styles.helper_text_class_style"
                v-html="class_styles.helper_text_class_style"
            ></span>
        </button>
...
const { input_value, error_text, is_loading } = state_refs;
</script>
